...
public interface IAuthService
{
    ...
    /// </summary>
    /// <param name="applicationUserModel">Os dados do usuário que será criado, incluindo nome, email, senha e outras informações.</param>
    ...
    Task CreateAsync(CreateApplicationUserModel applicationUserModel, CancellationToken cancellationToken);
    ...
    Task<UserDetailsModel?> FindByIdAsync(string userId);
    ...
    /// <returns>Um objeto <see cref="UserDetailsModel"/> contendo informações detalhadas do usuário se encontrado, ou null se o usuário não existir.</returns>
    ...
    /// <returns>Uma tarefa que, quando concluída, contém as informações detalhadas do usuário na forma de um <see cref="UserDetailsModel"/>, ou null se o usuário não for encontrado.</returns>
